...
void test_contactlist_operations(void) {
    ...
    ContactEntry* entry1 = createContactEntry();
    Contact* c1 = entry1->data;
    strcpy(c1->last_name, "Test1");
    strcpy(c1->first_name, "Test11");

    ContactEntry* entry2 = createContactEntry();
    Contact* c2 = entry2->data;
    strcpy(c2->last_name, "Test2");
    strcpy(c2->first_name, "Test22");

    insertEntry(&list, entry1);
    insertEntry(&list, entry2);
